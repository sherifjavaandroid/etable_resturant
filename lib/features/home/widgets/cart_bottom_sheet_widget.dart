...
import 'package:efood_table_booking/features/cart/domain/models/cart_model.dart' as cart;
...
import 'package:efood_table_booking/features/home/widgets/quantity_button_widget.dart';
import 'package:efood_table_booking/features/home/screens/product_image_screen.dart';
                                  ...
                                  Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    ...
                                    Row(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      ...
                                      (widget.product.image != null && widget.product.image!.isNotEmpty) ? Stack(children: [
                                       ...
                                       if(discount > 0)
                                         PriceStackTagWidget(value: PriceConverter.percentageCalculation(
                              ...
                              Flexible(
                                child: CustomButtonWidget(
                                  ...
                                  onPressed: widget.cart == null && !productController.checkStock(widget.product, quantity: cartController.getCartProductQuantityCount(widget.product))  ? null : isAvailable ? () {
                                    ...
                                    if(variationList.isNotEmpty){
                                      for(int index=0; index<variationList.length; index++) {
                                        if(!variationList[index].isMultiSelect! && variationList[index].isRequired!
                                          ...
                                          showCustomSnackBarHelper('${'choose_a_variation_from'.tr} ${variationList[index].name}', isToast: true, isError: true);
                                          return;
                                          ...
                                          showCustomSnackBarHelper('${'you_need_to_select_minimum'.tr} ${variationList[index].min} '
                                    ...
                                    showCustomSnackBarHelper('Item added to cart', isError: false, isToast: true);
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ProductController>(
      builder: (productController) {
        return Row(children: [
           QuantityButtonWidget(isIncrement: false, onTap: () {
           ...
           QuantityButtonWidget(
             ...
             onTap: (){
               ...
               if(productController.checkStock(
                 ...
                 showCustomSnackBarHelper('out_of_stock'.tr, isToast: true);
               }
             }
           ),
         ]);
