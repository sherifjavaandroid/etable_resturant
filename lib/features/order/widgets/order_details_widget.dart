...
import 'package:efood_table_booking/features/order/widgets/product_type_widget.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<OrderController>(
      builder: (orderController) {
        ...
        return orderController.currentOrderDetails == null ? Center(child: CustomLoaderWidget(
                          ...
                          Row(crossAxisAlignment: CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            Expanded(flex: 2,child: Column(
                              ...
                              children: [
                                ...
                                ProductTypeWidget(productType: details.productDetails?.productType),
                              ],
                            )),
