...
import 'package:efood_table_booking/features/cart/widgets/order_note_widget.dart';
import 'package:efood_table_booking/features/cart/widgets/table_input_widget.dart';
import 'package:efood_table_booking/features/home/widgets/cart_bottom_sheet_widget.dart';
import 'package:efood_table_booking/features/order/screens/payment_screen.dart';
import 'package:efood_table_booking/features/order/widgets/custom_divider_widget.dart';
      ...
      child: GetBuilder<SplashController>(builder: (splashController) {
          return GetBuilder<OrderController>(builder: (orderController) {
              return GetBuilder<CartController>(builder: (cartController) {
                ...
                return cartList.isEmpty ? NoDataWidget(text: 'please_add_food_to_order'.tr) : Column(
                  children: [
                    ...
                    Row(children: [
                      ...
                      InkWell(
                        onTap: (){
                          openResponsiveDialog(context, const TableInputWidget(),);
                        },
                              ...
                              children: [
                                ...
                                Row(crossAxisAlignment: CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.center, children: [
                                  ...
                                  Expanded(child: IconButton(
                                    onPressed: (){
                                      ...
                                      showCustomSnackBarHelper('cart_item_delete_successfully'.tr, isError: false, isToast: true);
                                    },
                                ...
                                Builder(
                                  builder: (context) {
                                    ...
                                    return !render ?
                                    Column(children: [
                                      CustomDividerWidget(color: Theme.of(context).disabledColor),
                                      SizedBox(height: Dimensions.paddingSizeSmall,),
                    ...
                    Column(
                      children: [
                        ...
                        if(showButton) Row(
                          children: [
                            if(cartController.cartList.isNotEmpty) Expanded(child: CustomButtonWidget(
                              ...
                              child: CustomButtonWidget(
                                ...
                                onPressed: (){
                                  ...
                                  if(splashController.getTableId() == -1) {
                                    showCustomSnackBarHelper('please_input_table_number'.tr);
                                  }else if(cartController.peopleNumber == null) {
                                    showCustomSnackBarHelper('please_enter_people_number'.tr);
                                  }else if(cartController.cartList.isEmpty) {
                                    showCustomSnackBarHelper('please_add_food_to_order'.tr);
                                  }else{
                                    List<Cart> carts = [];
    ...
    return Column(
      children: [
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          ...
          InkWell(
            onTap: (){
              openResponsiveDialog(context, OrderNoteWidget(
